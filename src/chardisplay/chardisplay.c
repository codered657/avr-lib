...
#define DISPLAY_CMD_DISPLAY_OFF 0x8
...
// Might want to make custom boolean type
#define FALSE 0
#define TRUE 1
...
void DisplayWriteStrToPosition(CharDisplay *display, uint8_t *str, uint8_t strLen, uint8_t row, uint8_t position) {
